        ...
        <div className="contact-content bg-[#e4f0e9da] w-full md:w-[66%] p-[20px] m-auto">
          ...
          <form className="contact-form p-[10px]">
            <div className="form-info flex justify-between mb-[10px] gap-5">
              <input type="text" name="first name" placeholder="First Name" className="p-[10px] w-1/2 outline-none rounded-[10px]" />
              <input type="text" name="last name" placeholder="Last Name" className="p-[10px] w-1/2 outline-none rounded-[10px]" />
            </div>
            <div className="form-info flex flex-col gap-[10px]">
              <label className="mb-[5px]" >Enter Your Email address</label>
              <input type="email" name="mail" placeholder="example@example.com" className="p-[10px] outline-none rounded-[10px]" />
            </div>
            <div className="form-info">
              <label className="block p-[10px] mb-[5px]" >Type in your message</label>
              <textarea name="messaage" placeholder="Write Your Message" className="block w-full h-[150px] p-[10px] resize-none outline-none rounded-[10px] placeholder:text-slate-400"></textarea>
            </div>
