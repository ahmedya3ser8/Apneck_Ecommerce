    ...
    <section className="py-12">
      <div className="container">
        ...
        <div className="customer-container grid justify-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
          <CustomerItems img={'/images/customers/customer-01.jpg'} />
          <CustomerItems img={'/images/customers/customer-02.jpg'} />
          <CustomerItems img={'/images/customers/customer-03.jpg'} />
          <CustomerItems img={'/images/customers/customer-04.jpg'} />
        </div>
      </div>
    </section>
  )
